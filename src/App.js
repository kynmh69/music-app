        ...
        <div className="flex flex-col min-h-screen bg-gray-900 text-white">
            <main className="flex-1 p-8 mb-20">
                ...
                <section>
                    ...
                    <SongList isLoading={isLoading} popularSongs={isSearchedResult ? searchedSongs : popularSongs}
                              onsongSelected={handleSongSelected}/>
                    {isSearchedResult &&
                        <Pagination onPrev={hasPrev ? moveToPrevious : null} onNext={hasNext ? moveToNext : null}/>}
                </section>
            </main>
